...
% 1.you can change hyperparameters of separate structure generation on lines 29-45 
% 2.you can change hyperparameters of merging on lines 130-147
...
%% PART 1: Generating 2 separate structures

% merging 2 cylinders:
% 1. generate first tensegrity with cylinder grid
% 2. shift possible coordinates by in (x,y) space and generate second
% tensegrity
% 3. combine connectivities(C,R), node coordinates, 
% 4. generate new merged tensegrity
...
shift = shift1;
sol1 = run_experiment(seed,n,true,grid_structure,shift,strut_constraint,strut_max_length,cable_constraint,...
                    cable_max_length,projection_constraint,projection_axis,projection_max_length);
...
shift = shift2;
sol2 = run_experiment(seed,n,true,grid_structure,shift,strut_constraint,strut_max_length,cable_constraint,...
                    cable_max_length,projection_constraint,projection_axis,projection_max_length);
...
dataname = strcat(grid_structure,"_unmerged_","c_constr:",string(cable_constraint),"_","s_constr:",string(strut_constraint),...
...
dataname = strcat(grid_structure,"_merged_","c_constr:",string(cable_constraint),"_","s_constr:",string(strut_constraint),...
    "_","proj_constr:",string(projection_constraint),"_ax:",string(projection_axis),".mat");
